...
![image-20220609183018132](https://zrsaber-blog.oss-cn-hangzhou.aliyuncs.com/img/image-20220609183018132.png)
...
3. 如果**一个链表有环**，**一个链表无环**，那么这**两个链表必不可能相交**
   ...
   ![image-20220609184214505](https://zrsaber-blog.oss-cn-hangzhou.aliyuncs.com/img/image-20220609184214505.png)
